...
export const viewAllDepartments = (startApp: () => void): void => {
  pool.query(
...
export const viewAllRoles = (startApp: () => void): void => {
  pool.query(
...
export const viewEmployees = (startApp: () => void): void => {
  pool.query(
    `SELECT
       e.id,
       e.first_name,
...
export const addDepartment = (startApp: () => void): void => {
  inquirer
    .prompt([
      {
        type: "input",
...
export const addRole = (startApp: () => void): void => {
...
export const addEmployee = (startApp: () => void): void => {
...
export const changeRole = async (startApp: () => void): Promise<void> => {
  try {
